		   ...
		   //Validation using Javascript
		        function validForm(){
				      //name
					   ...
					   if(isNaN(eAdhr)){
					         alert("Enter aadhar digits only!");
					        document.getElementById("Adhr").focus();
							return false; 
					   }
					    
					   if(eAdhr.length!=12){
					         alert("Enter aadhar 12 digits only!");
					        document.getElementById("Adhr").focus();
							return false; 
					   }
					   ...
					   if(isNaN(eConno)){
					         alert("Enter contact digits only!");
					        document.getElementById("Contact").focus();
							return false; 
					   }
					    
					   if(eConno.length!=10){
					         alert("Enter Contact 10 digits only!");
					        document.getElementById("Contact").focus();
							return false; 
					   }
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="vregcomp.php" method="POST" autocomplete="on"> 
								...
								<p> 
                                    <label for="email" class="email" data-icon="" >  E-mail Id(if any)</label>
                                    <input id="EmailId" name="EmailId" required="" type="text" placeholder="Email Id"/>
                                </p>      
								
								<p> 
                                    <label for="addhar" class="addhar" data-icon="" > Addhar No.</label>
								...
								<p> 
                                    ...
                                    <input id="Contact" name="Contact" required="" type="text" placeholder="Contact No"/>
                                </p>
